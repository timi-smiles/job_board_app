...
export default function SeekerLayout({
  ...
  const navItems = [
    { href: '/dashboard/seeker', label: 'Dashboard', icon: Home },
    { href: '/dashboard/seeker/profile', label: 'My Profile', icon: User },
    { href: '/dashboard/seeker/jobs', label: 'Browse Jobs', icon: Briefcase, badge: 'New' },
  ...
  return (
    <>
      {/* Onboarding Modal */}
      <JobSeekerOnboarding />
      {/* Push notification setup for candidates */}
